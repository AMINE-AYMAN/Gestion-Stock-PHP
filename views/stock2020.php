<?php 
	if(isset($_POST['find'])){
		$data = new StockController();
		$stocks = $data->findStocks();
	}else{
		$data = new StockController();
		$stocks = $data->getAllStock();
	}
?>
<div class="container">
	<div class="row my-4">
		<div class="col-md-12 mx-auto">
			...
			<div class="card">
				<div class="card-body bg-light">
					<a href="<?php echo BASE_URL;?>adds" class="btn btn-sm btn-primary mr-2 mb-2">
  ...
  &nbsp;  <button class="input-group-text" id="btnGroupAddon" style="cursor:pointer;"><i class="fas fa-search"></i></button>
					...
					<thead>
								...
								<tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"><?php echo $stock['descriptionn']; ?></td>
                                        <td class="text-center"><?php echo $stock['prix']; ?></td>
                                        <td class="text-center"><?php echo $stock['dateajoute']; ?></td>
                                        <td class="text-center">
						      	<?php if($stock['quantité']>10) {?>
                                             <span class="badge badge-success"><?php echo $stock['quantité']; ?></span>
						      	<?php } else{?>
                                         <span class="badge badge-danger"><?php echo $stock['quantité']; ?></span>
                                         <?php } ?>
						          </td>
                                        <td class="formedit">
                                            <form method="post" action="deletes" class="mr-2">
                                            ...
                                            <form method="post" action="updates" class="mr-2">
                                                 <input type="hidden" name="id" value="<?php echo $stock['id_produit']; ?>">
